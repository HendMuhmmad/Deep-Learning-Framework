...
class Model(Net):
  ...
  def train_by_epochs(self,X_train,Y_train,X_validation,Y_validation,epochs): 
    """
    :Description: train the model by epoch number 
    :Parameter X_train:numpy array of train features input
    :Parameter Y_train:numpy array of label of train samples
    :Parameter X_validation:numpy array of Validation features input
    :Parameter Y_validation:numpy array of label of Validation samples
    :Parameter epochs:int , numbers of epochs

    :returns:
    pred_training_np:numpy array for output predicted of train dataset 
    losses_training_np:numpy array of losses of train dataset
    pred_validation_np:numpy array for ouput predicted of validation dataset
    losses_validation_np:numpy array of losses of validation dataset
  ...
  def train_by_Loss(self,X_train,Y_train,X_validation,Y_validation,stopping_loss):
    """
    :Description: train the model by loss value 
    :Parameter X_train:numpy array of train features input
    :Parameter Y_train:numpy array of label of train samples
    :Parameter X_validation:numpy array of Validation features input
    :Parameter Y_validation:numpy array of label of Validation samples
    :Parameter stopping_loss:Float , loss to stop at
    ...
    pred_validation_np:numpy array for ouput predicted of validation dataset
    losses_validation_np:numpy array of losses of validation dataset
    epochs_no:number of epochs required to reach the specific loss 
    """ 
  ...
  def evaluate_accuracy(self,label,pred_np):
    """
    :Description: evaluate accuracy of model
    :Parameter label:numpy array of true label of  samples
    :Parameter pred_np:numpy array of predicted labels of Validation samples

    :returns:acc_np numpy array of floats ,accuracy 
  ...
  def evaluate_precision(self,label,pred_np):
    """
    :Description: evaluate precision of model
    :Parameter label:numpy array of true label of  samples
    :Parameter pred_np:numpy array of predicted labels of Validation samples

    :returns:precision_np:numpy array of precision of each class
    precision_dict dictionary with keys equal to string name of class & value equal to numpy array of the precision for the specific class
  ...
  def evaluate_recall(self,label,pred_np):
    """
    :Description: evaluate recall of model
    :Parameter label:numpy array of true label of samples
    :Parameter pred_np:numpy array of predicted labels of Validation samples

    :returns:recall_np numpy array of recall of each class
    recall_dict:dictionary with keys equal to string name of class & value equal to numpy array of the recall for the specific class
  ...
  def train_cnn_by_epochs_no(self,X_train,Y_train,X_validation,Y_validation,epochs,N_imgs):
    ...
    :Parameter Y_validation:numpy array of label of Validation samples
    :Parameter epochs:int , numbers of epochs
    :N_imgs:number of images to use from the dataset
