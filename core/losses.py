...
class Loss(Function):
    def forward(self, X, Y):
        """
        :Description:Computes the loss of x with respect to y.
        :Parameter X: numpy.ndarray of shape (n_batch, n_dim).
        :Parameter Y: numpy.ndarray of shape (n_batch, n_dim).
    ...
    def backward(self):
        """
         :Description:Backward pass for the loss function. Since it should be the final layer
    ...
    def local_grad(self, X, Y):
        """
        :Description:Local gradient with respect to X at (X, Y).
        :Parameter X: numpy.ndarray of shape (n_batch, n_dim).
        :Parameter Y: numpy.ndarray of shape (n_batch, n_dim).
...
class MeanSquareLoss(Loss):
    def forward(self, X, Y):
        """
        :Description:Computes the mean square error of X with respect to Y.
        :Parameter X: numpy.ndarray of shape (n_batch, n_dim).
        :Parameter Y: numpy.ndarray of shape (n_batch, n_dim).
...
class Multinomial_Logistic_Regression(Loss):
    ...
    def forward(self, probs, y_labels):
        """
        :Description:Computes the cross entropy loss of x with respect to y.
        :Parameter X: numpy.ndarray of shape (n_batch, n_dim).
        :Parameter y: numpy.ndarray of shape (n_batch, 1). Should contain class labels
    ...
    def local_grad(self, probs, y_labels):
        """
        :Description:Local gradient with respect to X at (X, Y).
        :Parameter Probs: numpy.ndarray of shape (n_batch, n_dim).
        :Parameter y_labels: numpy.ndarray of shape (n_batch, n_dim).

        :Returns:
            grad_np: numpy.ndarray of shape (n_batch, n_dim).
        """
